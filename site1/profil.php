...
<head>
    ...
    <link rel="stylesheet" href="site1/css/styleProfil.css" type="text/css" />
...
<body>
    <header class="accueil">
        <nav>
            <img class="burger" src="site1/images/menu.png" alt="Bouton ouverture du menu">
            <div class="menuCache">
                <img class="fermerMenu" src="site1/images/croix.png" alt="Bouton fermeture du menu">
                <a href="index.php" class="aBurger">Accueil</a>
                <a href="rechercherTrajet.php" class="aBurger">Rechercher un covoiturage</a>
                <a href="proposerUnTrajet.php" class="aBurger">Proposer un covoiturage</a>
                <a href="boutique.php" class="aBurger">Boutique</a>
                <?php
        ...
        <a href="index.php"><img class="logoHeader" src="site1/images/logoFest.png" alt="Logo Fest'"></a>
        <?php
            if(isset($_SESSION['IdUser']) AND $_SESSION['IdUser']>0){$getIdUser = intval($_SESSION['IdUser']);
        ...
        <a href="notifications.php" class="iconesDroite"><img src="site1/images/cloche.png" alt="Icône cloche de notifications" class="imgHeader"></a>
        <a href="profil.php?IdUser=<?php echo $getIdUser;?>" class="iconesDroite"><img class="imgHeader2" src="site1/images/utilisateur.png" alt="Icône profil utilisateur"></a>
        <?php } else {
            //Sinon, la cloche et l'icone utilisateur redirigent tout les deux vers la page de connexion.?>
        <a href="notifications.php" class="iconesDroite"><img class="imgHeader" src="site1/images/cloche.png" alt="Icône cloche de notifications"></a>
        <a href="connexion.php" class="iconesDroite"><img class="imgHeader2" src="site1/images/utilisateur.png" alt="Icône profil utilisateur"></a>
        <?php
            }
            ?>
    </header>
